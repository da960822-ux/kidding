...
const faqContent: Record<Locale, { title: string; items: Array<{ q: string; a: string }> }> = {
  ko: {
    ...
    items: [
      ...
      { q: '어떤 언어를 지원하나요?', a: '한국어를 기본으로 베트남어, 네팔어, 캄보디아어를 지원합니다.' },
    ],
  },
  vi: {
    ...
    items: [
      ...
      { q: 'Dịch vụ hỗ trợ những ngôn ngữ nào?', a: 'Dịch vụ hỗ trợ tiếng Hàn, tiếng Việt, tiếng Nepal và tiếng Khmer.' },
    ],
  },
  ne: {
    ...
    items: [
      ...
      { q: 'कुन भाषाहरू उपलब्ध छन्?', a: 'कोरियाली, भियतनामी, नेपाली र खमेर उपलब्ध छन्।' },
    ],
  },
  km: {
    title: 'សំណួរញឹកញាប់',
    items: [
      { q: 'តើ AI យល់ភាសាតំបន់ Jeolla ទេ?', a: 'យល់។ AI រៀបចំពាក្យសម្តីធម្មតាតាមបរិបទការងារ ហើយសួរបញ្ជាក់មុនបញ្ជូន ប្រសិនបើមានចំណុចមិនច្បាស់។' },
      { q: 'តើកម្មករត្រូវដំឡើងកម្មវិធីទេ?', a: 'មិនចាំបាច់ទេ។ 밭머리 ជាវេបអាប់សម្រាប់ទូរស័ព្ទ ហើយអាចប្រើបានដោយបើកតំណក្នុងកម្មវិធីរុករក។' },
      { q: 'តើគាំទ្រភាសាអ្វីខ្លះ?', a: 'សេវាកម្មគាំទ្រភាសាកូរ៉េ វៀតណាម នេប៉ាល់ និងខ្មែរ។' },
    ],
  },
};
