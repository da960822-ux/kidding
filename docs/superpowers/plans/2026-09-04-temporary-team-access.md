...
- [ ] Apply verified additive migration and deploy using established production projects if authorized access remains available. Report actual release and any delivery limits, never label foreground polling OS push.
