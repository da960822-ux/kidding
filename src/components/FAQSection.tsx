...
const faqContent: Record<Locale, { title: string; items: Array<{ q: string; a: string }> }> = {
  ko: {
    ...
    items: [
      ...
      { q: '어떤 언어를 지원하나요?', a: '한국어를 기본으로 베트남어와 네팔어를 지원합니다.' },
    ],
  },
  vi: {
    ...
    items: [
      ...
      { q: 'Dịch vụ hỗ trợ những ngôn ngữ nào?', a: 'Dịch vụ hỗ trợ tiếng Hàn, tiếng Việt và tiếng Nepal.' },
    ],
  },
  ne: {
    ...
    items: [
      ...
      { q: 'कुन भाषाहरू उपलब्ध छन्?', a: 'कोरियाली, भियतनामी र नेपाली उपलब्ध छन्।' },
    ],
  },
};
