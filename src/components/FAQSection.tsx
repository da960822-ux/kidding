...
const faqContent: Record<Locale, { title: string; items: Array<{ q: string; a: string }> }> = {
  ko: {
    title: '자주 묻는 질문',
    items: [
      { q: '전라도 사투리로 말해도 되나요?', a: '네. AI가 작업 지시로 정리하고, 애매한 내용은 농장주가 전달 전에 확인합니다.' },
      { q: '근로자는 앱을 설치해야 하나요?', a: '아니요. 받은 링크를 브라우저로 열면 바로 이용할 수 있습니다.' },
      { q: '어떤 언어를 지원하나요?', a: '현재 베트남어와 네팔어 작업 안내만 지원합니다.' },
    ],
  },
  vi: {
