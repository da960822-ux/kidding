...
- Owner API mutations require the shared-demo PIN session cookie. Worker links expire 24 hours after issue and always resolve the latest `PUBLISHED` WorkSession version. External access errors are generalized; expired links receive reissue guidance.
