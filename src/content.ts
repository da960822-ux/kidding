...
export const landingContent: Record<Locale, LandingContent> = {
  ko: {
    ...
    hero: {
      ...
      freeStart: '무료로 시작하기',
      viewGuide: '사용법 보기',
      benefits: ['사투리도 정확하게 이해해요', '베트남어·네팔어로 번역해요', '최신 지시를 바로 전달해요'],
    },
    phone: {
    ...
    features: {
      ...
      cards: [
        ...
        { title: '변경된 지시도 최신으로', description: '수량이 바뀌면 근로자에게 최신 작업지시를 다시 보여줘요.' },
      ],
    },
    ...
    how: {
      title: '사용 방법',
      steps: [
        { title: '말로 지시하기', description: '작업 내용을 평소 말투 그대로 말해요.' },
        { title: 'AI가 이해하고 번역', description: 'AI가 내용을 정리해 베트남어와 네팔어로 번역해요.' },
        { title: '근로자에게 전달', description: '번역된 내용을 근로자에게 전달해요.' },
        { title: '최신 지시 확인', description: '근로자가 바뀐 내용까지 최신 상태로 확인해요.' },
      ],
    },
  ...
  vi: {
    ...
    hero: {
      ...
      benefits: ['Hiểu cả tiếng địa phương', 'Dịch sang tiếng Việt và Nepal', 'Luôn gửi hướng dẫn mới nhất'],
    },
    phone: {
    ...
    features: {
      ...
      cards: [
        ...
        { title: 'Dịch sang hai ngôn ngữ', description: 'Truyền đạt công việc bằng tiếng Việt và tiếng Nepal.' },
    ...
    how: {
      ...
      steps: [
        ...
        { title: 'AI hiểu và dịch', description: 'AI sắp xếp nội dung rồi dịch sang tiếng Việt và tiếng Nepal.' },
  ...
  ne: {
    ...
    hero: {
      ...
      benefits: ['स्थानीय बोली पनि बुझ्छ', 'भियतनामी र नेपालीमा अनुवाद', 'सधैँ नयाँ निर्देशन पठाउँछ'],
    },
    phone: {
    ...
    features: {
      ...
      cards: [
        ...
        { title: 'दुई भाषामा अनुवाद', description: 'कामको निर्देशन भियतनामी र नेपालीमा पुर्‍याउँछ।' },
    ...
    how: {
      ...
      steps: [
        ...
        { title: 'AI ले बुझेर अनुवाद गर्छ', description: 'AI ले सामग्री मिलाएर भियतनामी र नेपालीमा अनुवाद गर्छ।' },
